...
Функция ПолучитьДанныеЗадачи(ЗадачаСсылка, ТипИнтеграции)
	...
	Запрос.Текст =
		...
		|ВЫБРАТЬ
		|	АВТОНОМЕРЗАПИСИ() КАК НомерЗаписи,
		|	cbr_ИсполнителиЗадачСрезПоследних.Задача,
		|	ЕСТЬNULL(cbr_ГруппыДоступаКЗадачамПользователи.Пользователь, cbr_ИсполнителиЗадачСрезПоследних.Исполнитель) КАК
		|		Исполнитель
		...
		|		ПО cbr_ИсполнителиЗадачСрезПоследних.Исполнитель = cbr_ГруппыДоступаКЗадачамПользователи.Ссылка
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
