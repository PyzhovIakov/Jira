...
Функция СтруктурыЭлементовЗаписи(ЗаписьКалендаря,
	...
	ЭлементПланировщика.Текст =  ?(ЗначениеЗаполнено(ЗаписьКалендаря.Текст),ЗаписьКалендаря.Текст, "" ) + Символы.ПС +  ЗаписьКалендаря.Описание ;
