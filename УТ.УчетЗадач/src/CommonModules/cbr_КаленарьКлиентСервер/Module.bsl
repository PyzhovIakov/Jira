...
//
// Возвращаемое значение:
//  Структура - содержит информацию о смещении часового пояса.
//              * НаправлениеСмещения - Строка - направление смещения ("+" или "-").
//              * СмещениеЧасов       - Число  - величина смещения в часах.
//              * СмещениеМинут       - Число  - остаток смещения в минутах.
//
