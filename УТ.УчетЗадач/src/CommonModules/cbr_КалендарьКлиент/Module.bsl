...
Процедура ОбработкаОкончанияРедактированияЭлемента(Планировщик, НовыйЭлемент, ОтменаРедактирования,
	ДанныеФормыПланировщик, НастройкиОтображения, УникальныйИдентификатор, ФизЛицоКалендаря, Предмет = Неопределено) Экспорт
	...
	Попытка
		...
		Если НовыйЭлемент Тогда
			...
			ПараметрыЗаписи.Вставить("Предмет", Предмет);
