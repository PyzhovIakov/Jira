...
Процедура Центр_ПроверкаВыполненияЭтаповКонтроля() Экспорт
	...
	Запрос.Текст =
		...
		|ИЗ
		|	Справочник.cbr_КонтрольНадЭтапамиЗадач КАК Центр_КонтрольНадЭтапамиЗадач
		|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.cbr_КонтрольНадЭтапамиЗадач.Параметры КАК Центр_КонтрольНадЭтапамиЗадачПараметры
