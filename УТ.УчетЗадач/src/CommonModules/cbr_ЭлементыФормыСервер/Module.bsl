...
//                    - ЭлементыФормы - можно в качестве родителя передать элемент формы
...
//                    - ЭлементыФормы - можно передать элемент формы
// Возвращаемое значение:
//	  ЭлементыФормы - Созданная обычная группа без отображения
//
...
//                    0 - Авто.
//    СтруктураСвойств - Структура - Содержит значения свойств, где ключ название свойства и значение
//    ЭлементПеред    - Строка - достаточно указать название элемента формы перед которым требуется вставить 
//    новый элемент.
//                    - ЭлементыФормы - можно передать элемент формы
// Возвращаемое значение:
//	  ЭлементыФормы - Созданная обычная группа
//
...
//
// Возвращаемое значение:
//	  ЭлементыФормы - Созданная группа страниц
//
Функция СздГруппаСтраниц(Форма, ИмяГруппы, РодительГруппы, РастягиватьГоризонтально = 0, РастягиватьВертикально = 0,
	ПриСменеСтраницы = "", СтруктураСвойств = Неопределено, ЭлементПеред = Неопределено) Экспорт
...
//                    0 - Авто.
//    СтруктураСвойств - Структура - Содержит значения свойств, где ключ название свойства и значение
//    СтраницаПеред    - Строка - достаточно указать название элемента формы перед которым требуется вставить 
//    новый элемент.
//                    - ЭлементыФормы - можно передать элемент формы
//
// Возвращаемое значение:
//	  ЭлементыФормы - Созданная страница
//
...
//
// Возвращаемое значение:
//	  ЭлементыФормы - Созданная группа командной панели
//
...
//
// Возвращаемое значение:
//	  ЭлементыФормы - Созданная группа
//
...
//
// Возвращаемое значение:
//	  ЭлементыФормы - Созданное поле формы
//
//@skip-check method-too-many-params
Функция СздПоле(Форма, ИмяПоля, РодительПоля, Заголовок, ШифрВидаПоля = 0, ПутьКДанным = "",
...
//
// Возвращаемое значение:
//	  ЭлементыФормы - Созданное поле флажка формы
//
//@skip-check method-too-many-params
...
//
// Возвращаемое значение:
//	  ЭлементыФормы - Созданная декорация
//
...
//
// Возвращаемое значение:
//	  ЭлементыФормы - Созданная кнопка
//
//@skip-check method-too-many-params
...
//  ЭлементПеред  - Строка - достаточно указать название элемента формы перед которым требуется вставить новый элемент
//                    - ЭлементыФормы - можно передать элемент формы
//  КанБанЭлемент - Булево - Индикатор того, является ли динамический список частью КанБана
//
// Возвращаемое значение:
//	  ЭлементыФормы - Таблица элемента созданного динамического списка
//
//@skip-check method-too-many-params
...
Функция СздДинамическийСписок(Форма, ИмяСписка = "Список", РодительСписка, ТекстЗапроса = "",
	...
	ЭлементПеред = Неопределено, КанБанЭлемент = Ложь) Экспорт
	...
	ТаблицаФормы = СздТаблицаФормы(Форма, ИмяСписка, РодительСписка, ИмяСписка, СтруктураКолонок, СтруктураСвойств,
		СтруктураСобытий, СвояКоманднаяПанель, ЭлементПеред, КанБанЭлемент);

	Если КанБанЭлемент Тогда
		ТаблицаФормы.ПутьКДаннымКартинкиСтроки = Неопределено;
	КонецЕсли;
...
// Родитель - ЭлементыФормы - Таблица, которой должна принадлежать создаваемая колонка
...
//    ОтображатьШапку - Булево - Определяет свойство отображения шапки у создаваемой колонки
//    ОтображатьПодвал - Булево - Определяет свойство отображения подвала у создаваемой колонки
//    СтруктураСвойств - Структура - Содержит значения свойств, где ключ название свойства и значение
//    СтруктураСобытий - Структура - Содержит значения событий, где ключ название события и в значение название процедуры тип "строка"
//    ЭлементПеред    - Строка - достаточно указать название элемента формы перед которым требуется вставить новый элемент
//                    - ЭлементыФормы - можно передать элемент формы
//
// Возвращаемое значение:
//	  ЭлементыФормы - Колонка таблицы формы
//
//@skip-check method-too-many-params
//@skip-check method-optional-parameter-before-required
...
//
// Возвращаемое значение:
//	  ЭлементыФормы - Созданная таблица формы
//
//@skip-check method-too-many-params
Функция СздТаблицаФормы(Форма, ИмяТаблицы, РодительТаблицы, ПутьКДанным, СтруктураКолонок = Неопределено,
	...
	СоздатьКолонкиДляТаблицыФормы(Форма, ТаблицаФормы, СтруктураКолонок, КанБанЭлемент);  
	
    // Оформление
	Если КанБанЭлемент Тогда
		ТаблицаФормы.ЧередованиеЦветовСтрок = Ложь;
		...
		ТаблицаФормы.МаксимальнаяВысотаВСтрокахТаблицы = 1;
		ТаблицаФормы.Шапка = Ложь;
		ТаблицаФормы.Ширина = 26;
...
//    Заголовок - Строка - Текст заголовка группы колонок
//    СтруктураСвойств - Структура - Содержит значения свойств, где ключ название свойства и значение
//    ЭлементПеред    - Строка - достаточно указать название элемента формы перед которым требуется вставить новый элемент
//                    - ЭлементыФормы - можно передать элемент формы
//
// Возвращаемое значение:
//	  ЭлементыФормы - Созданная группа колонок
//
//@skip-check method-too-many-params
...
//    МассивЗначений - Массив из Строка - массив значений выбора из списка (содержит строковый тип)
...
//
// Возвращаемое значение:
//	  ЭлементыФормы - Выпаадющий список формы
//
//@skip-check method-too-many-params
//@skip-check method-optional-parameter-before-required
...
//
// Возвращаемое значение:
//	  ЭлементыФормы - Поле переключателя формы
//
//@skip-check method-too-many-params
//@skip-check method-optional-parameter-before-required
...
//
// Возвращаемое значение:
//	  ЭлементыФормы - Поле формы, содержащее гиперссылку
//
//@skip-check method-too-many-params
Функция СздПолеГиперссылка(Форма, ИмяПоля, РодительПоля, Заголовок = "", БезЗаголовка = Истина, ПутьКДанным = "",
	СтруктураСвойств = Неопределено, СтруктураСобытий = Неопределено, ЭлементПеред = Неопределено) Экспорт
...
//    ПутьКДанным        - Строка - Путь к данным значения
//    СтруктураСвойств - Структура - Содержит значения свойств, где ключ название свойства и значение
//    СтруктураСобытий - Структура - Содержит значения событий, где ключ название события и в значение название 
//    процедуры тип "строка".
//    ЭлементПеред    - Строка - достаточно указать название элемента формы перед которым требуется вставить 
//    новый элемент.
//                    - ЭлементыФормы - можно передать элемент формы
//
// Возвращаемое значение:
//	  ЭлементыФормы - Поле надписи формы
//
//@skip-check method-too-many-params
Функция СздПолеНадписи(Форма, ИмяПоля, РодительПоля, Заголовок = "", БезЗаголовка = Истина, ПутьКДанным = "",
	СтруктураСвойств = Неопределено, СтруктураСобытий = Неопределено, ЭлементПеред = Неопределено) Экспорт
...
//
//Параметры:
//	  Форма - Форма - Форма, содержащая реквизиты для удаления
//    МассивУдаляемыхРеквизитов - Массив из Строка - Содержит строковые типы с именами реквизитов, ТОЛЬКО СОЗДАННЫЕ ПРОГРАММНО!
...
//
//Параметры:
//	  Форма - Форма - Форма, содержащая реквизит для удаления
...
//
//Параметры:
//	  Форма - Форма - Форма, содержащая элементы для удаления
//    МассивУдаляемыхЭлементов - Массив из Строка - Содержит строковые типы с именами удаляемых элементов, ТОЛЬКО СОЗДАННЫЕ ПРОГРАММНО!
...
//
//Параметры:
//	  Форма - Форма - Форма, содержащая элемент для удаления
...
//
//Параметры:
//	  Форма - Форма - Форма, содержащая реквизит и элемент для удаления
...
//
//Параметры:
//	  Форма - Форма - Форма, содержащая команду для удаления
//    ИмяКоманды - Строка - Имя удаляемой команды на форме, ТОЛЬКО СОЗДАННЫЕ ПРОГРАММНО!
...
//Удалить команды ранее созданных программно!
//
//Параметры:
//	  Форма - Форма - Форма, содержащая команды для удаления
//    МассивУдаляемыхКоманд - Массив из Строка - Массив имен  удаляемых команд на форме, ТОЛЬКО СОЗДАННЫЕ ПРОГРАММНО!
Процедура УдлКоманды(Форма, МассивУдаляемыхКоманд) Экспорт
	Для Каждого текКоманда Из МассивУдаляемыхКоманд Цикл
		КомандаФормы = Форма.Команды.Найти(текКоманда);
		Если КомандаФормы <> Неопределено Тогда
			Форма.Команды.Удалить(КомандаФормы);
		КонецЕсли;
	КонецЦикла;
...
//
//Возвращаемое значение:
//	ОписаниеТипов - "Строка" указанной длины
...
//
//Возвращаемое значение:
//	ОписаниеТипов - "Число" указанной длины и точности
...
//
//Возвращаемое значение:
//	ОписаниеТипов - "ДатаВремя" указанного типа
...
// Создание описания ссылочного типа документ
//
// Параметры:
// ИмяДокумента - Строка - Имя документа в дереве метаданных
//
//Возвращаемое значение:
//	ОписаниеТипов - "ДокументСсылка" с указанным именем
...
//
//Возвращаемое значение:
//	ОписаниеТипов - "СправочникСсылка" с указанным именем
...
//
//Возвращаемое значение:
//	ОписаниеТипов - "ПеречислениеСсылка" с указанным именем
...
//
//Возвращаемое значение:
//	КвалификаторыСтроки - квалификатор строки с указанной длиной
...
//
//Возвращаемое значение:
//	КвалификаторыЧисла - квалификатор числа с указанной длиной и точностью
...
//
//Возвращаемое значение:
//	КвалификаторыДаты - квалификатор даты с указанным типом
...
//
//Возвращаемое значение:
//		Структура - Структура основных свойств 
//@skip-check method-too-many-params
...
//Возвращаемое значение:
//		Структура - Структура свойств подсказки
...
// 
//Возвращаемое значение:
//		Структура - Структура свойств расположения элемента формы
//@skip-check method-too-many-params
...
//Устанавлвает для элемента до 10 различных структур свойств
//Параметры:
// Элемент - ЭлементыФормы - Элемент, для которого устанавливаются параметры
// СтруктураСвойств1 - Структура - Структура свойств для установки 
// СтруктураСвойств2 - Структура - Структура свойств для установки 
// СтруктураСвойств3 - Структура - Структура свойств для установки 
// СтруктураСвойств4 - Структура - Структура свойств для установки 
// СтруктураСвойств5 - Структура - Структура свойств для установки 
// СтруктураСвойств6 - Структура - Структура свойств для установки 
// СтруктураСвойств7 - Структура - Структура свойств для установки 
// СтруктураСвойств8 - Структура - Структура свойств для установки 
// СтруктураСвойств9 - Структура - Структура свойств для установки 
// СтруктураСвойств10 - Структура - Структура свойств для установки 
//@skip-check method-too-many-params
...
Функция СоздатьЭлементФормы(Форма, ИмяЭлемента, ТипЭлемента, РодительЭлемента, ЭлементПеред = Неопределено)
	Если ЭлементПеред = Неопределено Тогда
		НовыйЭлемент = Форма.Элементы.Добавить(ОчиститьОтЗапрещенныхСимволов(ИмяЭлемента), ТипЭлемента,
			РодительЭлемента);
	Иначе
		НовыйЭлемент = Форма.Элементы.Вставить(ОчиститьОтЗапрещенныхСимволов(ИмяЭлемента), ТипЭлемента,
			РодительЭлемента, ЭлементПеред);
	КонецЕсли;
	Возврат НовыйЭлемент;
КонецФункции

Процедура СоздатьКолонкиДляТаблицыФормы(Форма, ТаблицаФормы, СтруктураКолонок, КанБанЭлемент, ЭтоДС = Ложь)

	ИмяСписка = ТаблицаФормы.Имя;

	Если КанБанЭлемент Тогда
		НоваяГруппаЭлемента = Форма.Элементы.Добавить("ГруппаЭлемента" + ИмяСписка, Тип("ГруппаФормы"), ТаблицаФормы);
		НоваяГруппаЭлемента.Вид = ВидГруппыФормы.ГруппаКолонок;
		НоваяГруппа = Форма.Элементы.Добавить("ГруппаКолонок" + ИмяСписка, Тип("ГруппаФормы"), НоваяГруппаЭлемента);
		НоваяГруппа.Вид = ВидГруппыФормы.ГруппаКолонок;
		НоваяГруппа.Группировка = ГруппировкаКолонок.Горизонтальная;

		НоваяКолонкаТаблицы = СоздатьЭлементФормы(Форма, ИмяСписка + "ЦветПриоритета", Тип("ПолеФормы"), НоваяГруппа);
		НоваяКолонкаТаблицы.Вид = ?(ЭтоДС, ВидПоляФормы.ПолеНадписи, ВидПоляФормы.ПолеВвода);
		НоваяКолонкаТаблицы.АвтоМаксимальнаяВысота = Ложь;
		НоваяКолонкаТаблицы.АвтоМаксимальнаяШирина = Ложь;
		НоваяКолонкаТаблицы.ОтображатьВШапке = Ложь;
		НоваяКолонкаТаблицы.РастягиватьПоГоризонтали = Ложь;
		НоваяКолонкаТаблицы.ПутьКДанным = ТаблицаФормы.ПутьКДанным + "." + "ЦветПриоритета";
		НоваяКолонкаТаблицы.Ширина = 1;
		Шрифт = Новый Шрифт(, 1);
		НоваяКолонкаТаблицы.Шрифт = Шрифт;
		НоваяГруппаВложенных = Форма.Элементы.Добавить("ГруппаВложенныхКолонок" + ИмяСписка, Тип("ГруппаФормы"),
			НоваяГруппа);
		НоваяГруппаВложенных.Вид = ВидГруппыФормы.ГруппаКолонок;
	КонецЕсли;

	Для Каждого тКолонка Из СтруктураКолонок Цикл
		ИмяКолонки = тКолонка.Ключ;
		Если ИмяКолонки = "ЦветПриоритета" Тогда
			Продолжить;
		КонецЕсли;
		НоваяКолонкаТаблицы = СоздатьЭлементФормы(Форма, ИмяСписка + ИмяКолонки, Тип("ПолеФормы"), ?(КанБанЭлемент, ?(
			тКолонка.Ключ <> "Пустая", НоваяГруппаВложенных, НоваяГруппаЭлемента), ТаблицаФормы));
		НоваяКолонкаТаблицы.Вид = ?(ЭтоДС, ВидПоляФормы.ПолеНадписи, ВидПоляФормы.ПолеВвода);
		НоваяКолонкаТаблицы.АвтоМаксимальнаяВысота = Ложь;
		НоваяКолонкаТаблицы.АвтоМаксимальнаяШирина = Ложь;
		НоваяКолонкаТаблицы.ОтображатьВШапке = Ложь;
		...
		Если КанБанЭлемент Тогда
			Если тКолонка.Ключ <> "Пустая" Тогда
				НоваяКолонкаТаблицы.ЦветФона = Новый Цвет(220, 220, 220);
			Иначе
				Шрифт = Новый Шрифт(, 1);
				НоваяКолонкаТаблицы.Шрифт = Шрифт;
...
//
Функция ОчиститьОтЗапрещенныхСимволов(ПроверяемаяСтрока, ДопРазрешенныеСимволы = Неопределено) Экспорт
	...
	РазрешенныеСимволы = "абвгдеёжзийклмнопрстуфхцчшщъыьэюяАБВГДЕЁЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯ"
		+ "abcdefghijklmnopqrstuvwxyzQWERTYUIOPASDFGHJKLZXCVBNM" + "0123456789_";
