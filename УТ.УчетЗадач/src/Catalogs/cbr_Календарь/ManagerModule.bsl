...
//	//	|	И ЗаписиРабочегоКалендаря.ТипЗаписиКалендаря <> ЗНАЧЕНИЕ(Перечисление.cbr_ТипЗаписиКалендаря.ПовторяющеесяСобытие)
...
//// Возвращает структуру реквизитов записи календаря.ф
//// 
...
////
//// Параметры:
////  cbr_СостояниеЗаписиРабочегоКалендаря - ПеречислениеСсылка.СостоянияЗаписейРабочегоКалендаря - Состояние записи рабочего календаря.
...
//		И СостояниеЗаписиРабочегоКалендаря = Перечисления.cbr_СостояниеЗаписиРабочегоКалендаря.Принято Тогда
...
//	ИначеЕсли СостояниеЗаписиРабочегоКалендаря = Перечисления.cbr_СостояниеЗаписиРабочегоКалендаря.Принято Тогда
//		СостоянияЗанятости = Перечисления.СостоянияЗанятости.Занят;
//	ИначеЕсли СостояниеЗаписиРабочегоКалендаря = Перечисления.cbr_СостояниеЗаписиРабочегоКалендаря.Отклонено Тогда
