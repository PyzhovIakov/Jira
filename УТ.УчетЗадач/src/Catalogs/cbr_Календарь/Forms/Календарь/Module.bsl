...
Процедура ОтображаемаяДатаПроверкаПеретаскивания(Элемент, ПараметрыПеретаскивания,
	...
	ИначеЕсли ТипЗнч(ПараметрыПеретаскивания.Значение[0]) = Тип("Структура") Тогда
		СтандартнаяОбработка =
			Не cbr_КаленарьКлиентСервер.ЭтоЭлементЗаписиКалендаря(
...
Процедура ПланировщикПередНачаломРедактирования(Элемент, НовыйЭлемент, СтандартнаяОбработка)
	...
	cbr_КалендарьКлиент.ОбработкаПередНачаломРедактированиемЭлемента(Элемент,
...
Процедура ПланировщикПередНачаломБыстрогоРедактирования(Элемент, СтандартнаяОбработка)
	...
	cbr_КалендарьКлиент.ПланировщикПередНачаломБыстрогоРедактирования(Элемент,
		СтандартнаяОбработка);
...
Процедура СоздатьЗанятость(Команда)
	...
	cbr_КалендарьКлиент.СоздатьЗанятость(ДатаНачалаНовойЗаписи,
...
Процедура УстановитьДоступностьЭлементов()
	...
	Иначе
		...
		Элементы.ГруппаОписаниеЛегенды.Доступность = 
			cbr_КаленарьКлиентСервер.ПолучитьОтобразитьЗанятостьВДне(НастройкиОтображения);
...
Процедура УстановитьАвтообновление()
	...
	НастройкиАвтообновления = cbr_КалендарьСервер.ПолучитьНастройкиАвтообновленияФормы(ЭтаФорма);
...
Процедура ЗавершениеВыбратьКалендарьСотрудника(ВыбранныеСотрудники, ДопПараметры) Экспорт
	...
	ФизЛицаКалендаря.ЗагрузитьЗначения(
		cbr_КалендарьСервер.ФизЛицаСотрудников(ВыбранныеСотрудникиМассив));
