...
Процедура ОтклонитьНаСервере()   	
	...
	РегистрыСведений.cbr_ИсполнителиЗадач.ИзменениеПоследнейЗаписи(Основание, ИсполнительЗадачи, , ПричинаОтказа);
	...
	cbr_ДвиженияПоРегистрам.ДвижениеИсполнителиЗадач(Основание, Исполнитель, Истина);
