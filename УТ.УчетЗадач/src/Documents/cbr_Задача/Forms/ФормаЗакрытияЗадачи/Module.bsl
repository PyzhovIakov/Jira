...
Процедура ЗаписатьЗакрыть(Команда)
	...
	Если СписанныеЧасы < СогласованныеЧасы Тогда	
		...
		Возврат;
	ИначеЕсли СогласованныеЧасы = 0 И ТипОценки <> ПредопределенноеЗначение("Перечисление.cbr_ТипОценкиЧасов.ПоФакту") Тогда
...
Процедура ВвыводЧасов()
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		Если ВыборкаДетальныеЗаписи.ТипОценки = ПредопределенноеЗначение("Перечисление.cbr_ТипОценкиЧасов.Точная") Тогда
			СогласованныеЧасы = ВыборкаДетальныеЗаписи.До;
			СогласованныеЧасыСтрока = ВыборкаДетальныеЗаписи.До;
		ИначеЕсли ВыборкаДетальныеЗаписи.ТипОценки = ПредопределенноеЗначение("Перечисление.cbr_ТипОценкиЧасов.Рамочная") Тогда
