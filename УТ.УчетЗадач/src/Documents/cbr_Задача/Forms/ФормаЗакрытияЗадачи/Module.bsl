...
Процедура ВвыводЧасов()
	...
	|	КОЛИЧЕСТВО(cbr_Календарь.Ссылка) КАК КоличествоЗаписейКалендаря,
	|	ЕСТЬNULL(ВЫБОР
	...
	Если ВыборкаДетальныеЗаписи.Следующий() Тогда
		...
		Если КонтрольВремени Тогда
			Если Не ВыборкаДетальныеЗаписи.Согласовано Тогда
				Если ВыборкаДетальныеЗаписи.КоличествоЗаписейКалендаря > 0 Тогда
			...
			Иначе
				...
				ИначеЕсли ВыборкаДетальныеЗаписи.ТипОценки = ПредопределенноеЗначение(
					"Перечисление.cbr_ТипОценкиЧасов.Рамочная") Тогда
