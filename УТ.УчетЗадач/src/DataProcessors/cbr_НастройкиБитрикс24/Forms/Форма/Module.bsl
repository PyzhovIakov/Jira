...
Процедура ИзменитьДоступностьПолейФормы()
	...
	Если ЭтоПерваяНастройка И НЕ НастройкаЗавершена Тогда
...
Функция СоздатьСтруктуруНастроек()
	...
	НастройкиБитрикс.Вставить("Администратор", Администратор);
	НастройкиБитрикс.Вставить("КоличествоПопыток", КоличествоПопыток);
