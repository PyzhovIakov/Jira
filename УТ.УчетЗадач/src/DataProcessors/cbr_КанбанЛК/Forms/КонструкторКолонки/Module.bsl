...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	Если РольДоступна("cbr_ПолныеПраваДжира") Тогда
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "СохранитьПоУмолчанию", "Видимость",
				Истина);
	Иначе
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "СохранитьПоУмолчанию", "Видимость",
				Ложь);
	...
	ПараметрЦвет = Неопределено;
	Если Параметры.Свойство("Цвет", ПараметрЦвет) Тогда
		Если ЗначениеЗаполнено(ПараметрЦвет) Тогда
			Цвет = ПараметрЦвет;
		КонецЕсли;
	КонецЕсли;
