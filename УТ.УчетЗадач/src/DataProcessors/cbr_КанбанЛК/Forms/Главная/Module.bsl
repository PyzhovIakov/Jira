	...
	Пока Выборка.Следующий() Цикл
		...
		Для Каждого Задача Из ТаблицаЗадач Цикл
			ЗадачаКомпонент = СформироватьЗадачуДоски(ШаблонЗадачи, ШаблонИсполнительПользователь,
				ШаблонИконкиПользователя, ШаблонИконкиГруппы, Задача);
...
&НаСервереБезКонтекста
Функция СформироватьЗадачуДоски(ШаблонЗадачи, ШаблонИсполнительПользователь, ШаблонИконкиПользователя, ШаблонИконкиГруппы, Задача)
