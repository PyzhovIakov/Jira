...
Процедура ОтобразитьДоску()
	...
	|ИЗ
	|	РегистрСведений.cbr_НастройкиПользователейКолонокКанБан КАК Центр_НастройкиПользователейКолонокКанБан
	|ГДЕ
	...
	|ИЗ
	|	Документ.cbr_Задача КАК Центр_Задача
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.cbr_ИсполнителиЗадач.СрезПоследних КАК Центр_ИсполнителиЗадачСрезПоследних
	|		ПО Центр_Задача.Ссылка = Центр_ИсполнителиЗадачСрезПоследних.Задача
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.cbr_СтатусыЗадач.СрезПоследних КАК Центр_СтатусыЗадачСрезПоследних
	|		ПО Центр_Задача.Ссылка = Центр_СтатусыЗадачСрезПоследних.Задача
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.cbr_ПросроченныеДействияПоЗадачам КАК Центр_ПросроченныеДействияПоЗадачам
	|		ПО Центр_ПросроченныеДействияПоЗадачам.Задача = Центр_Задача.Ссылка
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.cbr_ДедлайнЗадач.СрезПоследних КАК Центр_ДедлайнЗадачСрезПоследних
	|		ПО Центр_ДедлайнЗадачСрезПоследних.Задача = Центр_Задача.Ссылка
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.cbr_ОценкаЧасов.СрезПоследних КАК Центр_ОценкаЧасовСрезПоследних
...
Процедура ПолучитьВыбраннуюДоску()
	...
	|ИЗ
	|	РегистрСведений.cbr_НастройкиПользователяКанБан КАК Центр_НастройкиПользователяКанБан
	|ГДЕ
	...
	|		ПОЛНОЕ СОЕДИНЕНИЕ Справочник.cbr_Доски КАК Центр_Доски
	|		ПО ИСТИНА
	|ГДЕ
