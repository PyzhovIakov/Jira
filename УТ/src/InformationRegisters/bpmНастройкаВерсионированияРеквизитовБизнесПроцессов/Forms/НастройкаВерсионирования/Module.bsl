...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//		КонецЦикла;
	//	КонецЕсли;
	//	Если СтруктураНастройки.СтруктураНастройки.Свойство("РеквизитыЗадачи")
		// И ТипЗнч(СтруктураНастройки.СтруктураНастройки.РеквизитыЗадачи) = Тип("Массив") Тогда
	...
	Если Модифицированность Тогда
		Если НЕ ПропуститьВопрос Тогда
			...
			ПоказатьВопрос(ОписаниеОповещения,
				 НСтр("ru='Данные были модифицированны. Сохранить данные?';
				|en='Data has been modified. Save data?'"),
