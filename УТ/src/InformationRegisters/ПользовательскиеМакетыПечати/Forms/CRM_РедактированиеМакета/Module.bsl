...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ОбщегоНазначения.ЭтоВебКлиент() И Не ОбщегоНазначения.ЭтоМобильныйКлиент() И ТипМакета = "MXL" Тогда
		Элементы.НадписьЗавершениеИзмененияНеВебКлиент.Заголовок = НСтр(
			"ru = 'После внесения необходимых изменений в макет нажмите на кнопку ""Завершить изменение""'; en = 'After you make changes in the template, click ""End editing""'");
	КонецЕсли;
...
Процедура ЗаписатьМакет(Макет)
	...
	// Создать элемент справочника "МакетыПечатныхФорм"
	...
	ОписаниеМакета.Наименование = ПредставлениеМакета;
