	...
	Если НЕ ПризнакФормаОткрытаПоПартнеру Тогда
		...
		Если ЗначениеЗаполнено(ДокументПроведен) Тогда
			Если ДокументПроведен = "Завершенные" Тогда
				CRM_ОбщегоНазначенияКлиентСервер.ИзменитьЭлементОтбораСписка(Список, "Проведен", Истина, Истина,
					 ВидСравненияКомпоновкиДанных.Равно);
			ИначеЕсли ДокументПроведен = "Незавершенные" Тогда
				CRM_ОбщегоНазначенияКлиентСервер.ИзменитьЭлементОтбораСписка(Список, "Проведен", Ложь, Истина,
					 ВидСравненияКомпоновкиДанных.Равно);
			КонецЕсли;
		КонецЕсли;	
	КонецЕсли; 
