...
Функция СкорректироватьСтрокиЗаказа(СтруктураПараметров) Экспорт
	...
	Запрос.УстановитьПараметр(
		...
		ВозвращаемыеТовары.Выгрузить(
			...
			"НомерСтроки, КодСтроки, Номенклатура, Склад, Характеристика, Упаковка, Количество, СуммаСНДС, Отменено"
		)
	);
	...
	Пока Выборка.Следующий() Цикл
		...
		ПараметрыПоиска = Новый Структура("Номенклатура,Склад,Характеристика, Отменено", 
		...
		Для Сч = 0 По СтрокиЗаказа.Количество()-1 Цикл
			...
			СтруктураПоискаОтклонений = Новый Структура("Номенклатура, Характеристика, Склад",
														Строка.Номенклатура,
