...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если CRM_ОбщегоНазначенияПовтИсп.ЭтоУТиВСК() Тогда
		CRM_МетодыФормСправочниковСервер.ФизическиеЛицаФормаЭлементаПриСозданииНаСервере(ЭтотОбъект, ЭтотОбъект["Объект"]);
	Иначе
		CRM_МетодыФормСправочниковСервер.ФизическиеЛицаФормаЭлементаПриСозданииНаСервере(ЭтотОбъект, ЭтотОбъект["ФизическоеЛицо"]);
	КонецЕсли;
	// -CRM
...
Процедура ПослеЗаписи(ПараметрыЗаписи)
	...
	// +CRM
	Если CRM_ОбщегоНазначенияПовтИсп.ЭтоУТиВСК() Тогда
		CRM_МетодыФормСправочниковКлиент.ФизическиеЛицаФормаЭлементаПослеЗаписи(ЭтотОбъект, ЭтотОбъект["Объект"]);
	Иначе
		CRM_МетодыФормСправочниковКлиент.ФизическиеЛицаФормаЭлементаПослеЗаписи(ЭтотОбъект, ЭтотОбъект["ФизическоеЛицо"]);
	КонецЕсли;
	// -CRM
