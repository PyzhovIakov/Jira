...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		...
		Если ДатаПоследнейСинхронизацииКонтактов = ДатаПоследнейСинхронизацииСобытий Тогда
			НадписьДатаСинхронизации = НСтр("ru='Дата последнего сеанса обмена:';en='Date of the last session of an exchange:'") 
				+ " " 
				+ Строка(ДатаПоследнейСинхронизацииКонтактов);
		Иначе
			Если ЗначениеЗаполнено(ДатаПоследнейСинхронизацииКонтактов) Тогда
				НадписьДатаСинхронизации = НСтр("ru='Дата последней синхронизации контактов:';en='Date of the last synchronization of contacts:'") 
					+ " " 
					+ Строка(ДатаПоследнейСинхронизацииКонтактов);
			КонецЕсли;
			Если ЗначениеЗаполнено(ДатаПоследнейСинхронизацииСобытий) Тогда
				НадписьДатаСинхронизации = НадписьДатаСинхронизации 
					+ ?(ЗначениеЗаполнено(НадписьДатаСинхронизации), Символы.ПС, "");
				НадписьДатаСинхронизации = НадписьДатаСинхронизации 
					+ НСтр("ru='Дата последней синхронизации мероприятий:';en='Date of the last event synchronization:'") + " " 
					+ Строка(ДатаПоследнейСинхронизацииСобытий);
			КонецЕсли;
			Если ЗначениеЗаполнено(ДатаПоследнейСинхронизацииПисем) Тогда
				НадписьДатаСинхронизации = НадписьДатаСинхронизации 
					+ ?(ЗначениеЗаполнено(НадписьДатаСинхронизации), Символы.ПС, "");
				НадписьДатаСинхронизации = НадписьДатаСинхронизации 
					+ НСтр("ru='Дата последней синхронизации писем:';en='Date of the last synchronization of letters:'") + " " 
					+ Строка(ДатаПоследнейСинхронизацииПисем);
			КонецЕсли;
