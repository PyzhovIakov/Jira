...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Для Каждого СтрокаТаблицыРегионов Из ТаблицаРегионов Цикл
		...
		СтрокаСуществующегоРегиона = ТаблицаСуществующихРегионов.Найти(СтрокаДереваРегионов.CRM_КодПоКлассификатору,
			 "КодРегиона");
		
		Если СтрокаСуществующегоРегиона = Неопределено Тогда
			СтрокаСуществующегоРегиона = ТаблицаСуществующихРегионов.Найти(СтрокаДереваРегионов.Наименование,
				 "Наименование");
		КонецЕсли;
