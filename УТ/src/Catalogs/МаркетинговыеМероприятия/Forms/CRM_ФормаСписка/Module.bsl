...
Процедура СписокВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	CRM_ЦентрМониторингаКлиент.НачатьЗамерОперацииБизнесСтатистики(
		"CRM_Статистика.Маркетинг.МаркетинговоеМероприятие.ДлительностьСценариев.ВремяОткрытияФормы", Истина);
...
Процедура ИзменитьВыделенные(Команда)
	...
	Иначе
		...
		ПоказатьПредупреждение(, НСтр("ru='Команда ""Изменить выделенное"" доступна только пользователям,
			| у которых есть роль ""Полные права"" или ""Управление маркетингом"".';
			|en='The ""Edit Selected"" command is only available to users who have the ""Full Rights"" or ""Marketing Management"" role.'"));
