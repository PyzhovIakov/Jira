...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	КонецЕсли;	
	Заголовок = НСтр("ru='Карта маршрута ';en='Flow chart'") + СокрЛП(мНаименование) 
		+ НСтр("ru=' (Версия №'") + Строка(НомерВерсии) + НСтр("ru=' от '") + Формат(ДатаСоздания,
		 "ДФ=dd.MM.yyyy") 
		+ ")";
...
&НаКлиенте
// Процедура сохраняет графичискую схему в файл.
//
Процедура СохранитьГрафическуюСхемуВФайл()
...
&НаКлиенте
Процедура СохранитьГрафическуюСхемуВФайлПродолжение(РасширениеПодключено, ДополнительныеПараметры) Экспорт
