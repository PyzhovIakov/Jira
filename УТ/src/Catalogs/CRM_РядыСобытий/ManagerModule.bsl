...
//
Функция ПолучитьПредставлениеРасписания(Знач Расписание = Неопределено, Ссылка = Неопределено,
	 ОграничитьДлиной = Неопределено) Экспорт
	Если Ссылка = Неопределено И Расписание = Неопределено Тогда
		Возврат "";
	КонецЕсли;
	...
	ПозицияТочкаСЗапятой = СтрНайти(ПредставлениеРасписания, ";");
...
//
Функция ПолучитьМассивДатРасписания(Знач ДатаНачало, Знач ДатаОкончания, Ссылка = Неопределено,
	 Знач Расписание = Неопределено) Экспорт
	...
	Если ДатаНачало > ДатаОкончания Тогда
		Возврат МассивДат;
	КонецЕсли;
