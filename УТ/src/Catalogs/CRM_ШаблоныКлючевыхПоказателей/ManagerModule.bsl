////////////////////////////////////////////////////////////////////////////////
// Процедуры и функции модуля менеджера "Справочники.CRM_ШаблоныКлючевыхПоказателей".
//
////////////////////////////////////////////////////////////////////////////////
...
//
Функция АдресаСхемыКомпоновкиДанныхИНастроекВоВременномХранилище(ЭлементСтруктурыЦелей,
	 ЭлементКопирования = Неопределено) Экспорт
	...
	Если ЗначениеЗаполнено(ЭлементСтруктурыЦелей.СхемаКомпоновкиДанных)
		 ИЛИ ЭлементСтруктурыЦелейСсылка.ХранилищеСхемыКомпоновкиДанных.Получить() = Неопределено
	...
	Если ЗначениеЗаполнено(ЭлементСтруктурыЦелей.СхемаКомпоновкиДанныхРасшифровки)
		 ИЛИ ЭлементСтруктурыЦелейСсылка.ХранилищеСхемыКомпоновкиДанныхРасшифровки.Получить() = Неопределено
		 И НЕ ЭлементСтруктурыЦелейСсылка.Пустая() Тогда
		СхемаИНастройки = ОписаниеИСхемаКомпоновкиДанныхЦелиПоИмениМакета(ЭлементСтруктурыЦелейСсылка,
			 ЭлементСтруктурыЦелей.СхемаКомпоновкиДанныхРасшифровки);
	...
	Если СхемаКомпоновкиДанных = Неопределено И ПустаяСтрока(ЭлементСтруктурыЦелей.СхемаКомпоновкиДанных) Тогда
		СхемаКомпоновкиДанных =
			Справочники.CRM_ШаблоныКлючевыхПоказателей.ПолучитьМакет("ШаблоннаяСхемаКомпоновкиДанныхПредопределенный");
	...
	ИначеЕсли СхемаКомпоновкиДанных = Неопределено И Не ПустаяСтрока(ЭлементСтруктурыЦелей.СхемаКомпоновкиДанных) Тогда
		СхемаКомпоновкиДанных =
			Справочники.CRM_ШаблоныКлючевыхПоказателей.ПолучитьМакет(ЭлементСтруктурыЦелей.СхемаКомпоновкиДанных);
	...
	Если СхемаКомпоновкиДанныхРасшифровки = Неопределено
		 И ПустаяСтрока(ЭлементСтруктурыЦелей.СхемаКомпоновкиДанныхРасшифровки) Тогда
		СхемаКомпоновкиДанныхРасшифровки =
			Справочники.CRM_ШаблоныКлючевыхПоказателей.ПолучитьМакет("ШаблоннаяСхемаКомпоновкиДанныхПредопределенный");
		Адреса.НаименованиеСхемы = "ШаблоннаяСхемаКомпоновкиДанныхПредопределенный";
		...
		КомпоновщикНастроек.ЗагрузитьНастройки(СхемаКомпоновкиДанных.НастройкиПоУмолчанию);
		НастройкиРасшифровки = КомпоновщикНастроек.ПолучитьНастройки();
	ИначеЕсли СхемаКомпоновкиДанныхРасшифровки = Неопределено
		 И Не ПустаяСтрока(ЭлементСтруктурыЦелей.СхемаКомпоновкиДанныхРасшифровки) Тогда
		СхемаКомпоновкиДанныхРасшифровки =
			Справочники.CRM_ШаблоныКлючевыхПоказателей.ПолучитьМакет(ЭлементСтруктурыЦелей.СхемаКомпоновкиДанныхРасшифровки);
		Адреса.НаименованиеСхемы = ЭлементСтруктурыЦелей.СхемаКомпоновкиДанных;
	...
	Адреса.СхемаКомпоновкиДанныхРасшифровки = ПоместитьВоВременноеХранилище(СхемаКомпоновкиДанныхРасшифровки,
	...
	Если ЗначениеЗаполнено(НастройкиРасшифровки) Тогда
		...
		Адреса.НастройкиКомпоновкиДанныхРасшифровки = ПоместитьВоВременноеХранилище(НастройкиРасшифровки,
			 Новый УникальныйИдентификатор());
	КонецЕсли;
...
Процедура ЗаполнитьПредопределенныеПоказатели(ПереданныйПоказатель = Неопределено) Экспорт
	...
	// ЗабытыеКлиенты
	Если ПереданныйПоказатель = Справочники.CRM_ШаблоныКлючевыхПоказателей.ЗабытыеКлиенты
		 Или ПереданныйПоказатель = Неопределено Тогда
		...
		Показатель.МетодГруппировкиЗначений = Перечисления.CRM_МетодыГруппировкиЗначенийПоказателей.Сумма;
		...
		ОбъектВиджет.КлючевойПоказатель = Показатель.Ссылка;
		ОбъектВиджет.ТипИсточникаДанных = Перечисления.CRM_ТипыИсточниковДанныхВиджетов.КлючевойПоказатель;
		...
		|				(ВЫБРАТЬ
		|					тмпАктивныеИнтересы.Партнер КАК Партнер
		|				ИЗ
	...
	КонецЕсли;
	// ЗагрузкаКалендаря
	Если ПереданныйПоказатель = Справочники.CRM_ШаблоныКлючевыхПоказателей.ЗагрузкаКалендаря
		 Или ПереданныйПоказатель = Неопределено Тогда
	...
	Если ПереданныйПоказатель = Справочники.CRM_ШаблоныКлючевыхПоказателей.КасанияНаОдногоКлиента
		 Или ПереданныйПоказатель = Неопределено Тогда
		...
		Показатель.КонтролируемыйПоказатель = "Количество";
		Показатель.МетодГруппировкиЗначений = Перечисления.CRM_МетодыГруппировкиЗначенийПоказателей.Среднее;
		Показатель.ЦелевойТренд = "Максимум";
		Показатель.КратностьЗначений = "НеИзменять";
		Показатель.ДробнаяЧасть = "Целое";
	...
	Если ПереданныйПоказатель = Справочники.CRM_ШаблоныКлючевыхПоказателей.КачествоКлиентскойБазы
		 Или ПереданныйПоказатель = Неопределено Тогда
	...
	Если ПереданныйПоказатель = Справочники.CRM_ШаблоныКлючевыхПоказателей.ПросроченоВзаимодействий
		 Или ПереданныйПоказатель = Неопределено Тогда
	...
	Если ПереданныйПоказатель = Справочники.CRM_ШаблоныКлючевыхПоказателей.ЗавершеноВзаимодействийИЗадачПоИнтересам
		 Или ПереданныйПоказатель = Неопределено Тогда
		...
		// СКД
		СхемаКомпоновкиДанных =
			Справочники.CRM_ШаблоныКлючевыхПоказателей.ПолучитьМакет("ЗавершеноВзаимодействийИЗадачПоИнтересам");
		Показатель.ХранилищеСхемыКомпоновкиДанных = Новый ХранилищеЗначения(СхемаКомпоновкиДанных);
		КомпоновщикНастроек = Новый КомпоновщикНастроекКомпоновкиДанных;
		КомпоновщикНастроек.Инициализировать(Новый ИсточникДоступныхНастроекКомпоновкиДанных(СхемаКомпоновкиДанных));
		КомпоновщикНастроек.ЗагрузитьНастройки(СхемаКомпоновкиДанных.НастройкиПоУмолчанию);
		...
		// Расшифровка
		СхемаКомпоновкиДанных =
			Справочники.CRM_ШаблоныКлючевыхПоказателей.ПолучитьМакет("РасшифровкаЗавершеноВзаимодействийИЗадачПоИнтересам");
		Показатель.ХранилищеСхемыКомпоновкиДанныхРасшифровки = Новый ХранилищеЗначения(СхемаКомпоновкиДанных);
		КомпоновщикНастроек = Новый КомпоновщикНастроекКомпоновкиДанных;
		КомпоновщикНастроек.Инициализировать(Новый ИсточникДоступныхНастроекКомпоновкиДанных(СхемаКомпоновкиДанных));
		КомпоновщикНастроек.ЗагрузитьНастройки(СхемаКомпоновкиДанных.НастройкиПоУмолчанию);
	...
	// Взаимодействия
	Если ПереданныйПоказатель = Справочники.CRM_ШаблоныКлючевыхПоказателей.Взаимодействия
		 Или ПереданныйПоказатель = Неопределено Тогда
		...
		Показатель.Наименование = НСтр("ru='Завершено взаимодействий по интересам за день';
			|en='Completed interactions on leads per day'");
	...
	КонецЕсли;
	// Продажи
	Если ПереданныйПоказатель = Справочники.CRM_ШаблоныКлючевыхПоказателей.Продажи
		 Или ПереданныйПоказатель = Неопределено Тогда
	...
	КонецЕсли;
	// ПроведениеВстреч
	Если ПереданныйПоказатель = Справочники.CRM_ШаблоныКлючевыхПоказателей.ПроведениеВстреч
		 Или ПереданныйПоказатель = Неопределено Тогда
	...
	КонецЕсли;
	// ТелефонныеЗвонки
	Если ПереданныйПоказатель = Справочники.CRM_ШаблоныКлючевыхПоказателей.ТелефонныеЗвонки
		 Или ПереданныйПоказатель = Неопределено Тогда
	...
	КонецЕсли;
	// ВысланныеКП
	Если ПереданныйПоказатель = Справочники.CRM_ШаблоныКлючевыхПоказателей.ВысланныеКП
		 Или ПереданныйПоказатель = Неопределено Тогда
	...
	КонецЕсли;
	// ВыставленныеСчета
	Если ПереданныйПоказатель = Справочники.CRM_ШаблоныКлючевыхПоказателей.ВыставленныеСчета
		 Или ПереданныйПоказатель = Неопределено Тогда
	...
	КонецЕсли;
	// ТеплыеКлиенты
	Если ПереданныйПоказатель = Справочники.CRM_ШаблоныКлючевыхПоказателей.ТеплыеКлиенты
		 Или ПереданныйПоказатель = Неопределено Тогда
	...
	КонецЕсли;
	// СреднийЧек
	Если ПереданныйПоказатель = Справочники.CRM_ШаблоныКлючевыхПоказателей.СреднийЧек
		 Или ПереданныйПоказатель = Неопределено Тогда
	...
	Если ПереданныйПоказатель = Справочники.CRM_ШаблоныКлючевыхПоказателей.ВходящиеТелефонныеЗвонки
		 Или ПереданныйПоказатель = Неопределено Тогда
	...
	Если ПереданныйПоказатель = Справочники.CRM_ШаблоныКлючевыхПоказателей.ИсходящиеТелефонныеЗвонки
		 Или ПереданныйПоказатель = Неопределено Тогда
	...
	// ВсеТелефонныеЗвонки
	Если ПереданныйПоказатель = Справочники.CRM_ШаблоныКлючевыхПоказателей.ВсеТелефонныеЗвонки
		 Или ПереданныйПоказатель = Неопределено Тогда
	...
	// ИсходящиеПисьма
	Если ПереданныйПоказатель = Справочники.CRM_ШаблоныКлючевыхПоказателей.ИсходящиеПисьма
		 Или ПереданныйПоказатель = Неопределено Тогда
	...
	// ИсходящиеСообщения
	Если ПереданныйПоказатель = Справочники.CRM_ШаблоныКлючевыхПоказателей.ИсходящиеСообщения
		 Или ПереданныйПоказатель = Неопределено Тогда
	...
	// ИнтересовВРаботе
	Если ПереданныйПоказатель = Справочники.CRM_ШаблоныКлючевыхПоказателей.ИнтересовВРаботе
		 Или ПереданныйПоказатель = Неопределено Тогда
	...
	Если ПереданныйПоказатель = Справочники.CRM_ШаблоныКлючевыхПоказателей.СуммаИнтересовВРаботе
		 Или ПереданныйПоказатель = Неопределено Тогда
		Показатель = Справочники.CRM_ШаблоныКлючевыхПоказателей.СуммаИнтересовВРаботе.ПолучитьОбъект();
		Показатель.КраткоеНаименование = НСтр("ru='Сумма новых интересов';en='Sum of new Leads'");
		Показатель.РеквизитДопУпорядочивания = 2;
		Показатель.ДополнительныеСвойства.Вставить("РеквизитаУпорядочиванияУстановлен", Истина);
		Показатель.ФормулаРасчета = "";
		Показатель.Включен = Истина;
	...
	// УспешныхИнтересов
	Если ПереданныйПоказатель = Справочники.CRM_ШаблоныКлючевыхПоказателей.УспешныхИнтересов
		 Или ПереданныйПоказатель = Неопределено Тогда
	...
	Если ПереданныйПоказатель = Справочники.CRM_ШаблоныКлючевыхПоказателей.СуммаУспешныхИнтересов
		 Или ПереданныйПоказатель = Неопределено Тогда
		Показатель = Справочники.CRM_ШаблоныКлючевыхПоказателей.СуммаУспешныхИнтересов.ПолучитьОбъект();
		Показатель.КраткоеНаименование = НСтр("ru='Сумма успешных интересов';en='Sum of successful Leads'");
		Показатель.РеквизитДопУпорядочивания = 4;
		Показатель.ДополнительныеСвойства.Вставить("РеквизитаУпорядочиванияУстановлен", Истина);
		Показатель.ФормулаРасчета = "";
		Показатель.Включен = Истина;
	...
	// +CRM_Модуль
	// ВаловаяПрибыль
	Если ПереданныйПоказатель = Справочники.CRM_ШаблоныКлючевыхПоказателей.ВаловаяПрибыль
		 Или ПереданныйПоказатель = Неопределено Тогда
		Показатель = Справочники.CRM_ШаблоныКлючевыхПоказателей.ВаловаяПрибыль.ПолучитьОбъект();
		Показатель.КраткоеНаименование = НСтр("ru='Валовая прибыль';en='Gross profit'");
		Показатель.РеквизитДопУпорядочивания = 5;
		Показатель.ДополнительныеСвойства.Вставить("РеквизитаУпорядочиванияУстановлен", Истина);
		Показатель.ФормулаРасчета = "";
		Показатель.Включен = Истина;
		...
		Показатель.ПериодАнализа = "Месяц";
		Показатель.ПериодАктуальности = "День";
		Показатель.Виджет = Справочники.CRM_Виджеты.ВаловаяПрибыль;
		ОбъектВиджет = Показатель.Виджет.ПолучитьОбъект();
		ОбъектВиджет.Наименование = Показатель.КраткоеНаименование;
		ОбъектВиджет.КлючевойПоказатель = Показатель.Ссылка;
		ОбъектВиджет.ТипИсточникаДанных = Перечисления.CRM_ТипыИсточниковДанныхВиджетов.КлючевойПоказатель;
		...
		Показатель.ЗначениеПериодаАктуальности = 1;
		Показатель.ЕдиницаИзмерения = Справочники.CRM_ЕдиницыИзмеренияПоказателей.руб;
		Показатель.СхемаКомпоновкиДанных = "ВаловаяПрибыль";
		Показатель.СхемаКомпоновкиДанныхРасшифровки = "ВаловаяПрибыль";
		// СКД
		СхемаКомпоновкиДанных = Справочники.CRM_ШаблоныКлючевыхПоказателей.ПолучитьМакет("ВаловаяПрибыль");
		Показатель.ХранилищеСхемыКомпоновкиДанных = Новый ХранилищеЗначения(СхемаКомпоновкиДанных);
		КомпоновщикНастроек = Новый КомпоновщикНастроекКомпоновкиДанных;
		КомпоновщикНастроек.Инициализировать(Новый ИсточникДоступныхНастроекКомпоновкиДанных(СхемаКомпоновкиДанных));
		КомпоновщикНастроек.ЗагрузитьНастройки(СхемаКомпоновкиДанных.НастройкиПоУмолчанию);
