...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ГруппаТаблицаКатегорииДобавитьУдалитьКатегорию.Видимость = Пользователи.РолиДоступны("CRM_АдминистрированиеБазыЗнаний,
		| ПолныеПрава");
...
Процедура КомандаДобавитьКатегорию(Команда)
	...
	ОткрытьФорму("Справочник.CRM_КатегорииРешений.ФормаОбъекта", ПараметрыФормы, ЭтотОбъект, , , , ,
...
Процедура КомандаИзменитьКатегорию(Команда)
	...
	Если ТекущиеДанные <> Неопределено Тогда 
		...
		ОткрытьФорму("Справочник.CRM_КатегорииРешений.Форма.ФормаЭлемента", ПараметрыФормы, ЭтотОбъект, ,
			 , ,
			 ОписаниеОповещения);
