...
Процедура УстановитьВидТочкиВОбработчиках() Экспорт
	...
	Пока Выборка.Следующий() Цикл
		Если Выборка.Вид = Перечисления.CRM_ВидыТочекМаршрута.Действие Тогда
			СтрокаОбработчика = Выборка.Ссылка.ОбработчикиСобытий.Найти(Справочники.CRM_ОбработчикиСобытийТочекМаршрута.ДействиеПередСозданиемЗадач,
				 "Событие");
		Иначе
			СтрокаОбработчика = Выборка.Ссылка.ОбработчикиСобытий.Найти(Справочники.CRM_ОбработчикиСобытийТочекМаршрута.ВложенныйБизнесПроцессПередСозданиемЗадач,
				 "Событие");
		КонецЕсли;
		...
		Если Выборка.Вид = Перечисления.CRM_ВидыТочекМаршрута.Действие Тогда
			СтрокаОбработчика = Выборка.Ссылка.ОбработчикиСобытий.Найти(Справочники.CRM_ОбработчикиСобытийТочекМаршрута.ДействиеПриСозданииЗадач,
				 "Событие");
		Иначе
			СтрокаОбработчика = Выборка.Ссылка.ОбработчикиСобытий.Найти(Справочники.CRM_ОбработчикиСобытийТочекМаршрута.ВложенныйБизнесПроцессПриСозданииЗадач,
				 "Событие");
		КонецЕсли;
