...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	Если Параметры.Свойство("Таблицы") Тогда
		...
		Параметры.Свойство("КИСинхронизироватьТелефоны", КИСинхронизироватьТелефоны);
		Параметры.Свойство("КИСинхронизироватьАдреса", КИСинхронизироватьАдреса);
...
Процедура ТелефоныВидКИНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Форма = ПолучитьФорму("Справочник.ВидыКонтактнойИнформации.ФормаВыбора",
		Новый Структура("Отбор, НачальноеЗначениеВыбора, РежимВыбора", Новый Структура("Тип", Типы), ТекСтрока, Истина), Элемент);
	Если Форма <> Неопределено Тогда
		...
		Если ЗначениеЗаполнено(ТекСтрока) И ЭлементСписок <> Неопределено Тогда
			ЭлементСписок.ТекущаяСтрока = ТекСтрока;
		КонецЕсли;
	КонецЕсли;
КонецПроцедуры
...
Процедура АдресаВидКИНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Форма = ПолучитьФорму("Справочник.ВидыКонтактнойИнформации.ФормаВыбора", Новый Структура("Отбор,
		|НачальноеЗначениеВыбора", Новый Структура("Тип", Типы), ТекСтрока),
		 Элемент);
	Если Форма <> Неопределено Тогда
		ЭлементСписок = Форма.Элементы.Найти("Список");
		Если ЭлементСписок <> Неопределено Тогда
