...
Процедура ПриОткрытии(Отказ)
	...
	АвтоЗаголовок = Ложь;
	Заголовок = ?(CRM_ШаблонОповещения,
		 НСтр("ru='Шаблоны сообщений SMS (Для оповещений)';en='SMS Message Templates (for notifications)'"),
		 НСтр("ru='Шаблоны сообщений SMS (Для рассылок)'"));
...
Процедура СписокВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если CRM_ШаблонОповещения Тогда
		Возврат;
	КонецЕсли;
