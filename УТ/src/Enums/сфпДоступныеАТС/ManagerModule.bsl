...
Функция СсылкиНаСтатьи() Экспорт
	...
	Ссылки.Добавить(Перечисления.сфпДоступныеАТС.Билайн,
		           		"https://moskva.beeline.ru/business/fixcon/telephony/cloud-ats/");
	Ссылки.Добавить(Перечисления.сфпДоступныеАТС.МТТ,           		"https://www.mango-office.ru/products/virtualnaya_ats");
	Ссылки.Добавить(Перечисления.сфпДоступныеАТС.MangoOffice,
		           "https://www.mango-office.ru/products/virtualnaya_ats");
	Ссылки.Добавить(Перечисления.сфпДоступныеАТС.ДомRu,
		                 "https://b2b.domru.ru/products/oats-new?utm_source=1c_unf&utm_medium=button&utm_campaign=federal");
	...
	Ссылки.Добавить(Перечисления.сфпДоступныеАТС.ВестКоллСПб,
		           "http://oats.westcall.spb.ru?utm_source=1C&utm_medium=cpc&utm_campaign=instrukciya");
	...
	Ссылки.Добавить(Перечисления.сфпДоступныеАТС.ТТК,
		                   "http://myttk.ru/business/services/virtualnaya_ats_/");
	...
	Ссылки.Добавить(Перечисления.сфпДоступныеАТС.ГарсТелеком,
		           "http://garstelecom.ru/for-business/all-solutions/virtualnaya-ats-ip-telefoniya/");
	...
	Ссылки.Добавить("МобильнаяТелефония",
		                            	"https://its.1c.ru/db/updinfo#content:479:1:issogl2_2");
