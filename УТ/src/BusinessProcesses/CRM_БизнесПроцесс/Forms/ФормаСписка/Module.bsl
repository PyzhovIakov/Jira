...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("Отбор") И ЗначениеЗаполнено(Параметры.Отбор) Тогда
		Если Параметры.Отбор.Свойство("КартаМаршрута") Тогда
			ОтборКартаМаршрута = Параметры.Отбор.КартаМаршрута;
		КонецЕсли;
...
Процедура ПриОткрытии(Отказ)
	...
	CRM_ТегиКлиент.БыстрыйОтборИзменение(ЭтотОбъект, ОтборКартаМаршрута, ОтборПроект, ОтборКлиент,
		 ОтборОтветственный,
		 ОтборПодразделение);
...
Процедура ПриЗагрузкеДанныхИзНастроекНаСервере(Настройки)
	ОтборКартаМаршрута = Настройки.Получить("ОтборКартаМаршрута");
