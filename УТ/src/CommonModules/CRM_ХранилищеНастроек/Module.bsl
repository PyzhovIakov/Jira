...
//
Функция Загрузить(КлючОбъекта, КлючНастроек = "", ОписаниеНастроек = Неопределено,
	...
	Результат = ХранилищеНастроекДанныхФорм.Загрузить(КлючОбъекта, КлючНастроек, ОписаниеНастроек,
...
//  ИмяПользователя	 - Строка - Имя пользователя, настройки которого загружаются.
//
Процедура Сохранить(КлючОбъекта, КлючНастроек = "", Настройки, ОписаниеНастроек = Неопределено,
	 Знач ИмяПользователя = Неопределено) Экспорт
	УстановитьПривилегированныйРежим(Истина);
...
//
Процедура УстановитьОписание(КлючОбъекта, КлючНастроек = "", ОписаниеНастроек,
	 Знач ИмяПользователя = Неопределено) Экспорт
	УстановитьПривилегированныйРежим(Истина);
