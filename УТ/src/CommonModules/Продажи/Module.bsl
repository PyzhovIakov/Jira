...
Процедура ДополнитьТекстыЗапросовОтчетРентабельностьПродажДаннымиДокументов(ТекстДополненияДанныеДокумента, ТекстДополненияСводныйРасчет) Экспорт
	...
	// +CRM_Модуль
	CRM_Модуль_ОбщегоНазначенияСервер.ДополнитьТекстыЗапросовОтчетРентабельностьПродажДаннымиДокументов(ТекстДополненияДанныеДокумента, ТекстДополненияСводныйРасчет);
	// -CRM_Модуль
...
Процедура ЗаполнитьЗаказаКлиентаНаОснованииКоммерческогоПредложенияКлиенту(ДокументОбъект, Знач Основание)
	...
	// +CRM
	|	КоммерческоеПредложениеКлиентуТовары.CRM_Содержание КАК Содержание,
	// -CRM
	|	ВЫБОР
