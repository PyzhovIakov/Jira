...
//      из которых необходимо произвести выбор(не учитываются для Телеграм).
//
Процедура ОткрытьURLОтправкиВМессенджерыЗавершение(ТекстСообщения, СсылкаДляПередачи, ПараметрыОтправки)
...
//
Процедура ОткрытьURLОтправкиВТелеграм(ТекстСообщения, СсылкаДляПередачи)
