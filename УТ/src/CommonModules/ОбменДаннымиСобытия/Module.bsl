...
Функция ЗначенияСвойствДляОбъекта(Объект, ПРО)
	...
	// +CRM
	Если ПРО.ИмяПланаОбмена = Метаданные.ПланыОбмена.CRM_СинхронизацияСМобильнымПриложениемНовый.Имя Тогда
		Возврат CRM_ОбменДаннымиСобытия.ЗначенияСвойствДляОбъекта(Объект, ПРО);
	КонецЕсли;
	// -CRM
