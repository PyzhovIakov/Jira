...
Процедура ПриНачалеРаботыСистемы(Параметры) Экспорт
	...
	// -Рабочий стол
	МодульCRM_СтраницаПриветствиеКлиент = ОбщегоНазначенияКлиент.ОбщийМодуль("CRM_СтраницаПриветствиеКлиент");
	МодульCRM_СтраницаПриветствиеКлиент.ПриНачалеРаботыСистемы();
	CRM_ОбщегоНазначенияКлиент.ПриНачалеРаботыСистемы();
	CRM_ЦентрМониторингаКлиент.ПриНачалеРаботыСистемы(Параметры);
	// -CRM
...
Процедура ПередПериодическойОтправкойДанныхКлиентаНаСервер(Параметры) Экспорт
	...
	// +CRM
	CRM_ОбщегоНазначенияКлиент.ПередПериодическойОтправкойДанныхКлиентаНаСервер(Параметры);
	// -CRM
...
Процедура ПослеПериодическогоПолученияДанныхКлиентаНаСервере(Результаты) Экспорт
	...
	// +CRM
	CRM_ОбщегоНазначенияКлиент.ПослеПериодическогоПолученияДанныхКлиентаНаСервере(Результаты);
	// -CRM
