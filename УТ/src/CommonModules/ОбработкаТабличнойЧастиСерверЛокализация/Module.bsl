...
Процедура ЗаполнитьСлужебныеРеквизитыПоНоменклатуреВСтрокеТЧ(ТекущаяСтрока, СтруктураДействий, КэшированныеЗначения, СтруктураДействийЗаполнения) Экспорт
	...
	Если СтруктураДействий.Свойство("ЗаполнитьСлужебныеРеквизитыПоНоменклатуреВСтрокеТЧ", СтруктураПараметровДействия)
		И ЗначениеЗаполнено(СтруктураПараметровДействия) Тогда
		
		СтруктураДействийЗаполнения.Вставить("ЗаполнитьСлужебныеРеквизитыПоНоменклатуреВСтрокеТЧ", СтруктураПараметровДействия);
	КонецЕсли;
...
Процедура ДополнитьПоддерживаемыеДействияЗаполненияТЧ(Действия) Экспорт
	...
	Действия.Добавить("ЗаполнитьПризнакПродажиТовараПоРазрешению");
...
Процедура СоответствиеКомандМетодам(Соответствие) Экспорт
	...
	Соответствие.Добавить("ЗаполнитьПризнакПродажиТовараПоРазрешению",						"ОбработкаТабличнойЧастиСервер.ЗаполнитьСлужебныеРеквизитыПоНоменклатуреВСтрокеТЧ");
