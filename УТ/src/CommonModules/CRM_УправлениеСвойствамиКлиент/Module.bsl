...
Процедура ОбновитьЗависимостиДополнительныхРеквизитов(Форма, Объект = Неопределено) Экспорт
	...
	// +CRM
	ИмяОписаниеОбъекта = "ОписаниеОбъекта";
	// -CRM
	...
	Для Каждого ОписаниеЗависимогоРеквизита Из Форма.Свойства_ОписаниеЗависимыхДополнительныхРеквизитов Цикл
		...
		Если ОписаниеЗависимогоРеквизита.УсловиеДоступности <> Неопределено Тогда
			...
			Параметры.Вставить(ИмяОписаниеОбъекта,
				?(ЗначениеЗаполнено(ОписаниеЗависимогоРеквизита.Объект), ОписаниеЗависимогоРеквизита.Объект, ОписаниеОбъекта));
			// -CRM
...
//  Элемент				 - КомандаФормы, ПолеФормы		 - элемент, нажатие которого необходимо обработать.
...
//  Объект				 - ДанныеФормыСтруктура, Неопределено	 - описание объекта, к которому подключены свойства,
//  	если свойство не указано или Неопределено, то объект будет взят из реквизита формы "Объект".
//
