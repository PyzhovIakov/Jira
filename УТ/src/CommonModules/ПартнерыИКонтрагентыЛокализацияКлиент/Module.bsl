...
Функция РезультатСравненияПолученныхДанныхКонтрагентаСИмеющимися(РеквизитыКонтрагента, ДанныеОбъекта, ЗаполнятьИНН) Экспорт
	...
	// +CRM_Модуль
	Результат.ЕстьИзменения = ?(Результат.ЕстьИзменения, Результат.ЕстьИзменения, 
								CRM_Модуль_РаботаСКонтрагентамиВызовСервера.СравнитьДанныеРуководителя(РеквизитыКонтрагента));
	// -CRM_Модуль
...
Процедура ЗаполнитьРеквизитыКонтрагентаПоПолученнымДанным(РеквизитыКонтрагента, Форма)
	...
	// +CRM_Модуль
	Если ОбщегоНазначенияКлиентСервер.ЕстьРеквизитИлиСвойствоОбъекта(РеквизитыКонтрагента, "Руководитель") Тогда
		CRM_Модуль_РаботаСКонтрагентамиКлиент.ЗаполнитьДанныеРуководителя(Форма, РеквизитыКонтрагента.Руководитель);
	КонецЕсли;
	// -CRM_Модуль
