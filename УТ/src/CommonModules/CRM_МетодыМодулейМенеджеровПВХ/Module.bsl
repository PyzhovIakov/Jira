...
Процедура ОчиститьНенужныеРеквизиты(Источник)
	...
	КонецЕсли;
	Если ((Источник.ТипОтвета <> Перечисления.ТипыОтветовНаВопрос.Число)
		 И (Источник.ТипОтвета <> Перечисления.ТипыОтветовНаВопрос.Строка)
...
Процедура CRM_ОбработкаПолученияПредставленияПВХОбработкаПолученияПредставления(Источник, Данные,
	 Представление,
	 СтандартнаяОбработка) Экспорт
КонецПроцедуры
