...
Процедура ЗаполнитьИсточникиДанныхДляПроверкиЗапретаИзменения(Знач ИсточникиДанных) Экспорт
	...
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных,	"Документ.CRM_ЭтапКалендарногоПлана",		"Дата",
			"CRM_Документы",
			"Подразделение");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных,	"Документ.CRM_ОтчетОРаботе",				"Дата",
			"CRM_Документы",
			"Подразделение");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных,	"Документ.CRM_ПланированиеВоронкиПродаж",
			"Дата",	"CRM_Документы",
			"Подразделение");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных,	"РегистрСведений.КурсыВалют"			,	"Период", 			 "", 	"");
	
	Если Метаданные.Имя = "CRM" Тогда
		ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных,	"Документ.CRM_СчетНаОплатуПокупателю",
				"Дата",	"CRM_Документы",
				"Подразделение");
	КонецЕсли;
