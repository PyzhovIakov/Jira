...
Функция ЗаписатьМакет(ОписаниеМакета) Экспорт
	...
	// +CRM
	Возврат CRM_УправлениеПечатью.ЗаписатьМакет(ОписаниеМакета);
	// -CRM
...
Функция СформироватьТабличныйДокумент(Макет, МассивОбъектов, ОбъектыПечати, КодЯзыка) Экспорт
	...
	// +CRM
	Возврат CRM_УправлениеПечатью.СформироватьТабличныйДокумент(Макет, МассивОбъектов, ОбъектыПечати, КодЯзыка);
	// -CRM
...
Функция ОписаниеМакета() Экспорт
	...
	// +CRM
	Возврат CRM_УправлениеПечатью.ОписаниеМакета();
	// -CRM
...
Функция НайтиМакет(ПутьКМакету, КодЯзыка, ТолькоПоставляемый = Ложь)
	...
	// +CRM
	Возврат CRM_УправлениеПечатью.НайтиМакет(ПутьКМакету, КодЯзыка, ТолькоПоставляемый);
	// -CRM
...
Процедура ДобавитьКомандыПечати(КомандыПечати, ОбъектМетаданных)
	...
	// +CRM
	CRM_УправлениеПечатью.ДобавитьКомандыПечати(КомандыПечати, ОбъектМетаданных);
	Возврат;
	// -CRM
