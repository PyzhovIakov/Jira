...
#КонецОбласти
	...
	// +CRM
	CRM_ЦентрМониторингаВызовСервера.ПриФормированииJSONДляОтправки(
		JSONСтруктура, Параметры, ПараметрыЦентраМониторинга);
	// -CRM
...
Функция ПолучитьПараметрыПоУмолчанию()
	...
	// +CRM
	CRM_ЦентрМониторингаВызовСервера.ПриПолученииПараметровПоУмолчанию(ПараметрыКонстанты);
	// -CRM
...
Процедура ЗаписатьДанныеСКлиента(Параметры)
	...
	// +CRM
	CRM_ЦентрМониторингаВызовСервера.ЗаписатьДанныеСКлиента(Параметры);
	Возврат;
	// -CRM
