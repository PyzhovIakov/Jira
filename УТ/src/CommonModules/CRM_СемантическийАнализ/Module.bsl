...
// Функция возвращает описание сущностей в тексте.
//
// Параметры:
//  ТекстДляАнализа	 - Строка	 - Текст для анализа.
//  ТаблицаСущностей - ТаблицаЗначений	 - Таблица сущностей.
// 
...
// Процедура выполняет фоновое получение сущности в тексте и сохраняет ее во временное хранилище.
//
// Параметры:
