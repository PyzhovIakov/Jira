...
// Подбирает изображения для подстановки или выбора в документ "Запрос коммерческих предложений у поставщика" 
// с целью дальнейшей публикации в сервисе.
// 
// Примечание:
// 	1. При добавлении нескольких файлов в результирующую таблицу, необходимо заполнить порядок сортировки. 
// 		Более приоритетными считаются записи с меньшей величиной числового значения в порядке сортировки.
// 	2. Файлы не должны быть помечены на удаление 
// 	3. Файлы должны принадлежать одному владельцу
// 	4. Максимальное количество изображений должно быть 100
// 
// Примеры реализации подбора изображения для автоподстановки в документ ЗКП при добавлении товара в табличную часть:
...
// 		1) Получает все файлы с признаком ПубликуетсяВСервисах 
// 		2) Если среди полученных с признаком ПубликуетсяВСервисах файлов есть тот, 
// 			который используется в качетсве файла картинки, добавляет в таблицу результата его.  
...
// 		Добавляет в таблицу результат любой из файлов с признаком ПубликуетсяВСервисах.
// 		
// Пример реализации подбора изображений для вывода в форму выбора изображений 
// 	для последующей подстановки в документ ЗКП: 
// 		Добавляет все присоединненые файлы, соответствующие параметрам подбора, с сортировкой по дате добавления 
// 		файла в систему.
// 	
// Параметры:
...
//  Отказ - Булево - Признак неуспешности добавления файла в систему. Истина - файл не добавлен. 
