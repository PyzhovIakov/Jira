...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	времНастройки = CRM_ХранилищеНастроек.Загрузить(ИмяФормы, "Настройки");
...
Процедура ОбработатьДанныеСтрокиКлиент(ДанныеСтроки, ИмяПоля, СтандартнаяОбработка)
	...
	СтрокаПоля = НайтиСтрокуСоответствия(ЭтотОбъект, ИмяПоля);
...
Процедура ОбновитьОтображениеУстановленныхОтборов()
	...
	Если ДекорацияЛогическоеВыражениеВидимость Тогда
		Элементы.ДекорацияЛогическоеВыражениеОтбораКлассификаторов.Заголовок = ?(ЛогическоеВыражениеОтбораКлассификаторов = "ИЛИ",
