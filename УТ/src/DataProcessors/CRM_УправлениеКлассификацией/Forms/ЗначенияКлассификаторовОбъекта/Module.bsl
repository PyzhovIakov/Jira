...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	Если Параметры.Свойство("ВладелецКлассификации", ВладелецКлассификации) Тогда
		CRM_КлассификаторыЭкспортныеМетоды.ФормаОбъектаПриЧтенииНаСервере(ЭтотОбъект, ВладелецКлассификации);
	КонецЕсли;
КонецПроцедуры
...
Процедура Подключаемый_Классификатор_ДобавитьТег(Элемент)
	...
	CRM_КлассификаторыКлиентСервер.НайтиИзменитьСтрокиКлассификаторовПоЗначению(ЭтотОбъект, ЭтотОбъект[Элемент.Имя], Истина);
...
Процедура Подключаемый_ТегКлассификатора_ОбработкаСсылки(Элемент, НавигационнаяСсылка, СтандартнаяОбработка)
	...
	CRM_КлассификаторыКлиентСервер.ОбработкаНавигационнойСсылкиТегаКлассификаторов(ЭтотОбъект, Элемент,
		 НавигационнаяСсылка,
...
&НаКлиенте
Процедура ГиперссылкаПерейтиЗначенияКлассификаторовОбработкаНавигационнойСсылки(Элемент,
