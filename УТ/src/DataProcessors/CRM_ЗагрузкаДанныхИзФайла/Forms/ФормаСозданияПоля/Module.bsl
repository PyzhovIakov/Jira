...
Процедура СправочникПриИзменении(Элемент)
	...
	Если ОбъектыСДопРекИКИ[Справочник].ДополнительныеРеквизиты Тогда
		...
		Элементы.ТипПоля.СписокВыбора.Добавить(Новый ОписаниеТипов("СправочникСсылка.ЗначенияСвойствОбъектов"),
			 НСтр("ru='Справочник';en='Catalog'"));
	КонецЕсли;
...
Функция СоздатьДополнительныйРеквизит()
	...
	НовыйДопРеквизит.ДополнительныеЗначенияИспользуются =
		(ТипПоля = Новый ОписаниеТипов("СправочникСсылка.ЗначенияСвойствОбъектов"));
