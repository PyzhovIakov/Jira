...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(Параметры.ПараметрыРаспознаванияРечи) Тогда 
	
		ВариантИспользования = Параметры.ПараметрыРаспознаванияРечи.ВариантИспользования;
		КодЯзыка             = Параметры.ПараметрыРаспознаванияРечи.КодЯзыка;
		Акустика             = Параметры.ПараметрыРаспознаванияРечи.Акустика;
		Грамматика           = Параметры.ПараметрыРаспознаванияРечи.Грамматика;
		Версия               = Параметры.ПараметрыРаспознаванияРечи.Версия;
		
	КонецЕсли;
	
	НастройкиРаботыСРечью = Константы.CRM_НастройкиРаботыСРечью.ПолучитьБезопасно();
...
Процедура АвторизацияСеанса(Команда)
	...
	ОткрытьФорму("Обработка.CRM_ПараметрыРаспознаванияРечи.Форма.АвторизацияСеанса");
...
&НаСервере
Процедура ЗаполнитьСписокВыбораПоЗначениямКолонки(Элемент, Таблица, ИмяКолонки)
...
Функция РезультатСохранитьПолучить()
	...
	Результат = РегистрыСведений.CRM_ПараметрыРаспознаванияРечи.ПараметрыПоУмолчанию();
	...
	РегистрыСведений.CRM_ПараметрыРаспознаванияРечи.Сохранить(Результат, Параметры.ИмяФормы);
