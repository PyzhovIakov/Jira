...
Процедура ОтборПартнерПриИзменении(Элемент)
	...
	CRM_ТегиКлиент.БыстрыйОтборИзменение(
		ЭтотОбъект, ТекущийВидЖурнала, ОтборПоТипуОбъекта, ОтборОтветственный, ОтборПартнер);
...
Процедура ЗаполнитьДоступныеДляСозданияОбъекты()
	...
	Иначе
		...
		УдаляемоеЗначение =
			ДоступныеДляСозданияОбъекты.НайтиПоЗначению(ПланыВидовХарактеристик.CRM_ОбъектыЖурналаДокументов.НайтиПоНаименованию("Взаимодействие"));
