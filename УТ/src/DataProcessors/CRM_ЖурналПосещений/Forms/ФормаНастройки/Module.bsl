...
Процедура ОК(Команда)
	СтруктураВозврата = Новый структура("Камера,Мероприятие,НаименованиеСтенда1,НаименованиеСтенда2,
		|ИнфоНадписьПервоеПосещениеНовыйКлиент,ИнфоНадписьНеПервоеПосещениеНовыйКлиент,
		|ИнфоНадписьПервоеПосещениеНеНовыйКлиент,ИнфоНадписьНеПервоеПосещениеНеНовыйКлиент",
...
Процедура МероприятиеПриИзмененииНаСервере()
	//ЗаполнитьЗначенияСвойств(Объект, Объект.Мероприятие, "ИнфоНадписьПервоеПосещениеНовыйКлиент,
		//|ИнфоНадписьНеПервоеПосещениеНовыйКлиент,ИнфоНадписьПервоеПосещениеНеНовыйКлиент,
		//|ИнфоНадписьНеПервоеПосещениеНеНовыйКлиент");
