...
Процедура ЗарегистрироватьРазрегистрироватьОбъекты(МассивТипов, Зарегистрировать,
	...
	Иначе
		ТекстЗапроса =
			"ВЫБРАТЬ Объект КАК Ссылка ИЗ РегистрСведений.CRM_СостоянияВоронкиПродаж ГДЕ Объекта В (&МассивОбъектов)";
