...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ОткрытьСценарииПоручений.Видимость = ПолучитьФункциональнуюОпцию("CRM_ИспользоватьКлассификаторы");
	Элементы.ГруппаНастройкиБП.Доступность = НЕ ВариантПоставкиСтартИлиСтандарт;
	Если ВариантПоставкиСтартИлиСтандарт Тогда
		Элементы.ИспользоватьПоручения.РасширеннаяПодсказка.Заголовок = 
			Элементы.ИспользоватьПоручения.РасширеннаяПодсказка.Заголовок + Символы.ПС
			+ НСтр("ru='Доступно только для ""ПРОФ"" и ""КОРП"" версий конфигурации!'");
	КонецЕсли;
	
	Элементы.ИспользоватьДатуИВремяВСрокахЗадач.Видимость = НаборКонстант.CRM_ИспользоватьБизнесПроцессы;
