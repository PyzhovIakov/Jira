...
// -РаботаСHTML
// +Диалоги
Перем глИспользуютсяДиалогиНаРабочемСтоле Экспорт; // Флаг использования диалогов на рабочем столе.
Перем глОткрытаФормаДиалогов Экспорт;              // Истина, если форма диалогов открыта.
Перем глЗаголовокДиалогов Экспорт;                 // Заголовок диалогов.
// -Диалоги
// -CRM
...
Процедура ОбработкаВнешнегоСобытия(Источник, Событие, Данные)
	...
	// +CRM
	#Если МобильныйКлиент Тогда
		Выполнить("сфпСофтФонПроКлиент.сфпВнешнееСобытияСофтфона(Источник, Событие, Данные)");
	#Иначе
