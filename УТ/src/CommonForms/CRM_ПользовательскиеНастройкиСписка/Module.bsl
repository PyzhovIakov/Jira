...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	Если	Параметры.Свойство("СвойстваДинамическогоСписка")
		...
		Если Параметры.Свойство("ИдентификаторНастройкиШаблон")
			 И ЗначениеЗаполнено(Параметры.ИдентификаторНастройкиШаблон) Тогда
		...
		СохраненныеНастройки = CRM_ОбщегоНазначенияСервер.ВосстановитьПользовательскиеНастройкиДинамическогоСписка(ИдентификаторСписка,
			 ИдентификаторДляСохраненныхНастроек);
