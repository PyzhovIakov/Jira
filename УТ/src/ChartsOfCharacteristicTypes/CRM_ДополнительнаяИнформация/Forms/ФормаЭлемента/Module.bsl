...
&НаКлиенте
Процедура ЗаписатьОбъект(ВариантТекстаВопроса, ИмяПроцедурыПродолжения,
...
&НаКлиенте
Процедура ЗначенияПередНачаломДобавленияЗавершение(Отказ, // АПК:78 - исключить из проверки.
...
&НаКлиенте
Процедура ЗначенияПередНачаломИзмененияЗавершение(Отказ, // АПК:78 - исключить из проверки.
	 ДополнительныеПараметры) Экспорт
...
&НаКлиенте
Процедура ДополнительныеЗначенияСВесомПриИзмененииЗавершение(Отказ, // АПК:78 - исключить из проверки.
	 Неопределен) Экспорт
